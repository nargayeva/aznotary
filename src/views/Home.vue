  ...
  <div>
      ...
      <div class="row">
        <div class="col-12 mb-4 text-center">
          <span class="title-president"
            >“BİZİM HƏDƏFİMİZ ƏRAZİ BÜTÖVLÜYÜMÜZÜN BƏRPA EDİLMƏSİ İDİ, BUNA NAİL
            OLDUQ”</span
          >
    ...
    <div class="container mt-5 p-0">
      <div class="row">
        <div class="col-12 mb-4 text-center">
          <span class="title"
            >VƏTƏN MÜHARİBƏSİ İŞTİRAKÇISI OLMUŞ ƏMƏKDAŞLARIMIZI TANIYAQ</span
          >
        </div>
      </div>
      ...
      >
       ...
       <div class="col-md-3 col-9 box text-center mb-5" id="ayxan">
        ...
        <div class="col-md-3 col-9 box text-center mb-5" id="shamxal">
          <img
            src="../../public/images/shamxal.jpg"
            alt="Avatar"
            class="image"
          />
          <div class="overlay">
